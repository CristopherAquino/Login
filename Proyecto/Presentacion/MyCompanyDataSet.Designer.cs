...
namespace Presentacion {
    ...
    public partial class MyCompanyDataSet : global::System.Data.DataSet {
        ...
        public partial class ClientesDataTable : global::System.Data.TypedTableBase<ClientesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ClientesRow AddClientesRow(string Nombre, string Apellido, string Direccion, string Ciudad, string Email, string Telefono, string Ocupacion) {
            ...
            private void InitClass() {
                ...
                this.columnApellido.MaxLength = 23;
                ...
                this.columnOcupacion.MaxLength = 70;
            }
...
namespace Presentacion.MyCompanyDataSetTableAdapters {
    ...
    public partial class ClientesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Clientes] WHERE (([ID] = @Original_ID) AND ([Nombre] = @Original_Nombre) AND ([Apellido] = @Original_Apellido) AND ([Direccion] = @Original_Direccion) AND ([Ciudad] = @Original_Ciudad) AND ([Email] = @Original_Email) AND ([Telefono] = @Original_Telefono) AND ([Ocupacion] = @Original_Ocupacion))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Clientes] ([Nombre], [Apellido], [Direccion], [Ciudad], [Email], [Telefono], [Ocupacion]) VALUES (@Nombre, @Apellido, @Direccion, @Ciudad, @Email, @Telefono, @Ocupacion);
SELECT ID, Nombre, Apellido, Direccion, Ciudad, Email, Telefono, Ocupacion FROM Clientes WHERE (ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Clientes] SET [Nombre] = @Nombre, [Apellido] = @Apellido, [Direccion] = @Direccion, [Ciudad] = @Ciudad, [Email] = @Email, [Telefono] = @Telefono, [Ocupacion] = @Ocupacion WHERE (([ID] = @Original_ID) AND ([Nombre] = @Original_Nombre) AND ([Apellido] = @Original_Apellido) AND ([Direccion] = @Original_Direccion) AND ([Ciudad] = @Original_Ciudad) AND ([Email] = @Original_Email) AND ([Telefono] = @Original_Telefono) AND ([Ocupacion] = @Original_Ocupacion));
SELECT ID, Nombre, Apellido, Direccion, Ciudad, Email, Telefono, Ocupacion FROM Clientes WHERE (ID = @ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Nombre, Apellido, Direccion, Ciudad, Email, Telefono, Ocupacion FROM d" +
                "bo.Clientes";
        ...
        public virtual int Fill(MyCompanyDataSet.ClientesDataTable dataTable) {
        ...
        public virtual MyCompanyDataSet.ClientesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            MyCompanyDataSet.ClientesDataTable dataTable = new MyCompanyDataSet.ClientesDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(MyCompanyDataSet.ClientesDataTable dataTable) {
        ...
        public virtual int Delete(int Original_ID, string Original_Nombre, string Original_Apellido, string Original_Direccion, string Original_Ciudad, string Original_Email, string Original_Telefono, string Original_Ocupacion) {
        ...
        public virtual int Insert(string Nombre, string Apellido, string Direccion, string Ciudad, string Email, string Telefono, string Ocupacion) {
            if ((Nombre == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nombre, string Apellido, string Direccion, string Ciudad, string Email, string Telefono, string Ocupacion, int Original_ID, string Original_Nombre, string Original_Apellido, string Original_Direccion, string Original_Ciudad, string Original_Email, string Original_Telefono, string Original_Ocupacion) {
            return this.Update(Nombre, Apellido, Direccion, Ciudad, Email, Telefono, Ocupacion, Original_ID, Original_Nombre, Original_Apellido, Original_Direccion, Original_Ciudad, Original_Email, Original_Telefono, Original_Ocupacion, Original_ID);
        }
    }
